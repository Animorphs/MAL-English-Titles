...
2. <b>Why am I seeing the English title twice and not the Japanese title at all?</b> In the [MAL Default Settings](https://myanimelist.net/editprofile.php?go=listpreferences), set "Anime Titles" and "Manga Titles" to "Main Title".
