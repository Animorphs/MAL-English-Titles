...
3. <b>Why am I getting no translations at all on 'x' page?</b> Currently, this script supports the following endpoints: <i>[animelist](https://myanimelist.net/animelist/testuser), [mangalist](https://myanimelist.net/mangalist/testuser), [top anime](https://myanimelist.net/topanime.php), [top manga](https://myanimelist.net/topmanga.php), [search](https://myanimelist.net/search/all?q=shingeki&cat=all), [anime search](https://myanimelist.net/anime.php?q=shingeki&cat=anime), </i> and <i>[manga search](https://myanimelist.net/manga.php?q=shingeki&cat=manga)</i>. If you have another page you would like translations for, please create a feature request.
